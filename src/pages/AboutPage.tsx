          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card hover:shadow-md transition-all duration-300 flex flex-col">
              ...
              <p className="text-gray-600">
                We prioritize your needs and goals, providing personalized service and tailored solutions for every client, whether you're a first-time buyer or seasoned investor.
              </p>
            </div>
