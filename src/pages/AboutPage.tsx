          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Founded in 2016, Crownline Properties has rapidly established itself as a trusted name in London's property market, particularly for international investors and landlords seeking a reliable partner for their UK property investments.
              </p>
              <p className="text-lg text-gray-700 mb-6">
      ...
      <section className="section bg-offwhite">
        <div className="container-custom">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12">
            ...
            <div className="w-32 h-24 bg-white rounded-property shadow-subtle flex items-center justify-center p-4">
              <img 
                src="https://cdn.pixabay.com/photo/2021/10/05/21/18/award-6683769_1280.png" 
            ...
            <div className="w-32 h-24 bg-white rounded-property shadow-subtle flex items-center justify-center p-4">
              <img 
                src="https://cdn.pixabay.com/photo/2014/04/03/11/36/graduation-cap-311979_1280.png" 
